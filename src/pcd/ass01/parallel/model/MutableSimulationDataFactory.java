...
public class MutableSimulationDataFactory {

    private final double dt = 0.001;

    public MutableSimulationData createSimulationData(
            List<Body> bodies,
            Boundary bounds,
            double dt,
            long maxIteration
    ) {
        return new RealMutableSimulationData(bodies, bounds, dt, maxIteration);
    }

    public MutableSimulationData testBodySet1_two_bodies(long maxIteration) {
        ...
        return createSimulationData(bodies, bounds, dt, maxIteration);
    }

    public MutableSimulationData testBodySet2_three_bodies(long maxIteration) {
    ...
    public MutableSimulationData testBodySet4_many_bodies(long maxIteration, int nBodies) {
